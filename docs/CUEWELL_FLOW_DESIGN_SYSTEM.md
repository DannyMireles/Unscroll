# Cuewell Flow Design System

Cuewell should feel calm, premium, and fluid. The UI language is built around rounded system typography, airy spacing, glass surfaces, and restrained motion that helps users understand state changes without feeling busy.

## Principles

- Use rounded system typography app-wide through `cuewellTypography()` and `AppTheme.Typography`.
