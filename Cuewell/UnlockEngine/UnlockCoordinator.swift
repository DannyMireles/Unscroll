...
final class UnlockCoordinator: ObservableObject {
    ...
    private func lockWithCapturedIdentity(_ lock: AppLock, appName: String?, bundleID: String?) -> AppLock {
        ...
        NSLog(
            "🔗 Cuewell: captured notification identity id=%@ bundle=%@ name=%@ scheme=%@",
    ...
    /// pop up whenever Cuewell was opened for any reason.
...
/// the "train your mind to unlock with intention" angle.
...
enum DailyStatsStore {
    private static let key = "cuewell.daily.stats"
